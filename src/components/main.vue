...
export default class Main extends Vue {
    ...
    public calcul(){
        this.mensualite = Math.round((this.montant - this.apport)/(this.duree*12));
        this.interet = Math.round((this.montant - this.apport)*(this.taux/100)*(1/12));
        if(this.apportPc === 0)
            this.apport = 0;
        else
